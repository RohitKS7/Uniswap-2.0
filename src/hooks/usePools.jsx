...
export const usePools = () => {
  ...
  //   useEffect will run whenever the "readOnlyChainId, readOnlyUrls" changes
  useEffect(() => {
    // This function will return the exact providerUrl for loadPools to use and then useState will change according to it.
